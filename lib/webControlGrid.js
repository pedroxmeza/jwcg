			...
			try	{
				...
				for(var r = 0;r < this.nRows;	r++){
					...
					for(var c = 0 ; c < this.nCols; c++){
						...
						/*********************************************************** 
  						TODO:
                en caso de que el contenido sea texto, 
                eliminto espacios en blanco y los remplazo
                por "&nbsp;"" pero si el contenido de la celda es html  
                debo de alguna forma indicarlo y quitar esta funcionalidad
						*/
