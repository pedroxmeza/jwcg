...
function webControlGrid() {
    ...
    this.nRowsAux             = null;							// numero de filas auziliar (busquedas) 
		...
		this.searchMethod         = "boyermoore"      // metodo de búsqueda 
    ...
    // pagination
    this .enablePagination    = false;            // habilita o deshabilita paginación
    this.rowsInPage           = 0;                // registros por página
		...
		*/
		...
		this.render	= function() {
		    ...
		    this.bgCellSelected       = "";  
				...
				/* 
           Con paginación, firstRowInPage y rowsToDisplay corresponde al bloque
				   de páginas definidas en rowsInPage  
        */ 
